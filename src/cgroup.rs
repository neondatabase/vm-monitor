...
/// Use to represent data that is associated with a certain point in time, such
...
pub struct CgroupWatcher {
    ...
    ///
    /// This is wrapped in a mutex because otherwise we need `&mut self` to
    ...
    ///
    /// Like the `events` field, this doesn't _need_ interior mutability but we
